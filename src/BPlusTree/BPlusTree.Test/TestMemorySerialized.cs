...
{
    [TestFixture]
    public class BasicMemorySerialized : BasicTests
    {
    ...
    [TestFixture]
    public class TestMemorySerialized : TestDictionary<BPlusTree<int, string>, TestSimpleDictionary.BTreeFactory, int, string>
    {
